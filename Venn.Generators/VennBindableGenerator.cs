...
namespace Venn.Generators
{
    [Generator]
    public class VennBindableGenerator : ISourceGenerator
    {
        private const string attributeText = @"
            using System;
            namespace Venn.Attributes
            {
                [AttributeUsage(AttributeTargets.Field, Inherited = false, AllowMultiple = false)]
                [System.Diagnostics.Conditional(""VennBindableGenerator_DEBUG"")]
                sealed class VennBindableAttribute : Attribute
                {
        ...
        public void Initialize(GeneratorInitializationContext context)
        {
            ...
            context.RegisterForPostInitialization((i) => i.AddSource("VennBindableAttribute.g.cs", attributeText));
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            INamedTypeSymbol attributeSymbol = context.Compilation.GetTypeByMetadataName("Venn.Atributtes.VennBindableAttribute");
            ...
            if (attributeSymbol != null && notifySymbol != null)
            {
                ...
                foreach (IGrouping<INamedTypeSymbol, IFieldSymbol> group in receiver.Fields.GroupBy<IFieldSymbol, INamedTypeSymbol>(f => f.ContainingType, SymbolEqualityComparer.Default))
                {
                    ...
                    context.AddSource($"{group.Key.Name}_vennBindable.g.cs", SourceText.From(classSource, Encoding.UTF8));
                }
            }
            ...
            public void OnVisitSyntaxNode(GeneratorSyntaxContext context)
            {
                    ...
                    && fieldDeclarationSyntax.AttributeLists.Count > 0)
                {
                    foreach (VariableDeclaratorSyntax variable in fieldDeclarationSyntax.Declaration.Variables)
                    {
                        ...
                        if (fieldSymbol.GetAttributes().Any(ad => ad.AttributeClass.ToDisplayString() == "Venn.Atributtes.VennBindableAttribute"))
                        {
